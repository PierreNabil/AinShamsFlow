...
def get(loss_name):
    ...
    losses = [MSE, MAE, MAPE, HuberLoss, LogLossLinearActivation, LogLossSigmoidActivation,MultiClassificationsLoss,PerceptronCriterionLoss,SSDLoss,SvmHingeLoss,BinaryCrossEntropy,CategoricalCrossEntropy]
    for loss in losses:
